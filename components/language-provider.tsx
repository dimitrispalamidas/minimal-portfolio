...
const translations = {
  "en": {
    ...
    "projects.description": "Client work, products, and collaborations — live where the app is up.",
    "projects.all": "All",
  ...
  "el": {
    ...
    "projects.description": "Client δουλειές, προϊόντα και collaborations — live όπου η εφαρμογή είναι πάνω.",
    "projects.all": "Όλα",
